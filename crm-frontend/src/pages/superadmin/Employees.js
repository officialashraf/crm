      ...
      <div class="card-body text-center">
        <a class="d-block mb-2" href="javascript:void(0)" data-toggle="modal" data-target="#modal-contact">
          <div class="image mb-3 d-inline-flex mt-n8">
            <img src="/monocss/images/user/user-md-1.jpg" class="img-fluid rounded-circle d-inline-block" alt="Avatar Image"/>
          </div>
  ...
  <div class="col-lg-6 col-xl-4 col-xxl-3">
    <div class="card card-default mt-7">
      <div class="card-body text-center">
        <a class="d-block mb-2" href="javascript:void(0)" data-toggle="modal" data-target="#modal-contact">
          <div class="image mb-3 d-inline-flex mt-n8">
            <img src="/monocss/images/user/user-md-2.jpg" class="img-fluid rounded-circle d-inline-block" alt="Avatar Image"/>
          </div>
  ...
  <div class="col-lg-6 col-xl-4 col-xxl-3">
    <div class="card card-default mt-7">
      <div class="card-body text-center">
        <a class="d-block mb-2" href="javascript:void(0)" data-toggle="modal" data-target="#modal-contact">
          <div class="image mb-3 d-inline-flex mt-n8">
            <img src="/monocss/images/user/user-md-3.jpg" class="img-fluid rounded-circle d-inline-block" alt="Avatar Image"/>
          </div>
  ...
  <div class="col-lg-6 col-xl-4 col-xxl-3">
    <div class="card card-default mt-7">
      <div class="card-body text-center">
        <a class="d-block mb-2" href="javascript:void(0)" data-toggle="modal" data-target="#modal-contact">
          <div class="image mb-3 d-inline-flex mt-n8">
            <img src="/monocss/images/user/user-md-4.jpg" class="img-fluid rounded-circle d-inline-block" alt="Avatar Image"/>
          </div>
  ...
  <div class="col-lg-6 col-xl-4 col-xxl-3">
    <div class="card card-default mt-7">
      <div class="card-body text-center">
        <a class="d-block mb-2" href="javascript:void(0)" data-toggle="modal" data-target="#modal-contact">
          <div class="image mb-3 d-inline-flex mt-n8">
            <img src="/monocss/images/user/user-md-5.jpg" class="img-fluid rounded-circle d-inline-block" alt="Avatar Image"/>
          </div>
  ...
  <div class="col-lg-6 col-xl-4 col-xxl-3">
    <div class="card card-default mt-7">
      <div class="card-body text-center">
        <a class="d-block mb-2" href="javascript:void(0)" data-toggle="modal" data-target="#modal-contact">
          <div class="image mb-3 d-inline-flex mt-n8">
            <img src="/monocss/images/user/u6.jpg" class="img-fluid rounded-circle d-inline-block" alt="Avatar Image"/>
          </div>
  ...
  <div class="col-lg-6 col-xl-4 col-xxl-3">
    <div class="card card-default mt-7">
      <div class="card-body text-center">
        <a class="d-block mb-2" href="javascript:void(0)" data-toggle="modal" data-target="#modal-contact">
          <div class="image mb-3 d-inline-flex mt-n8">
            <img src="/monocss/images/user/u7.jpg" class="img-fluid rounded-circle d-inline-block" alt="Avatar Image"/>
          </div>
  ...
  <div class="col-lg-6 col-xl-4 col-xxl-3">
    <div class="card card-default mt-7">
      <div class="card-body text-center">
        <a class="d-block mb-2" href="javascript:void(0)" data-toggle="modal" data-target="#modal-contact">
          <div class="image mb-3 d-inline-flex mt-n8">
            <img src="/monocss/images/user/u8.jpg" class="img-fluid rounded-circle d-inline-block" alt="Avatar Image"/>
          </div>
