      ...
      {/* // <div class="content"> */}
        <div class="card card-default">
          <div class="card-header align-items-center px-3 px-md-5">
            ...
            <button
              type="button"
              className=" bg-primary px-4 py-2 rounded text-light"
              data-toggle="modal"
            ...
            <div class="row">
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-1.jpg"
              ...
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-2.jpg"
                      class="mr-3 img-fluid rounded"
                      alt="Avatar Image"
                    />
              ...
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-3.jpg"
                      class="mr-3 img-fluid rounded"
                      alt="Avatar Image"
                    />
              ...
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-4.jpg"
                      class="mr-3 img-fluid rounded"
                      alt="Avatar Image"
                    />
              ...
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-5.jpg"
                      class="mr-3 img-fluid rounded"
                      alt="Avatar Image"
                    />
              ...
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-6.jpg"
                      class="mr-3 img-fluid rounded"
                      alt="Avatar Image"
                    />
                    <div class="media-body">
              ...
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-7.jpg"
                      class="mr-3 img-fluid rounded"
                      alt="Avatar Image"
                    />
              ...
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-8.jpg"
                      class="mr-3 img-fluid rounded"
                      alt="Avatar Image"
                    />
              ...
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-9.jpg"
                      class="mr-3 img-fluid rounded"
                      alt="Avatar Image"
                    />
              ...
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-10.jpg"
                      class="mr-3 img-fluid rounded"
                      alt="Avatar Image"
                    />
              ...
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-11.jpg"
                      class="mr-3 img-fluid rounded"
                      alt="Avatar Image"
                    />
              ...
              <div class="col-lg-6 col-xl-4">
                <div class="card card-default p-4">
                  ...
                  >
                    <img
                      src="/monocss/images/user/u-xl-12.jpg"
                      class="mr-3 img-fluid rounded"
                      alt="Avatar Image"
                    />
                      ...
                      <div class="card text-center px-0 border-0">
                        <div class="card-img mx-auto">
                          <img
                            ...
                            src="/monocss/images/user/u6.jpg"
                            alt="user image"
                          />
                        </div>
            ...
            <div class="modal-content">
              <form>
                ...
                <div class="modal-footer px-4">
                  <button
                    type="button"
                    className="bg-smoke btn-pill px-3 py-2 text-light rounded"
                    data-dismiss="modal"
                  >
                    Cancel
                  </button>
                  <button type="button" class="bg-primary btn-pill text-light px-4 py-2 rounded">
                    Save Contact
                  </button>
                </div>
              </form>
